...
- Admin：server/storage/data-usage/account/config-help、pool/rebalance/tier/site-replication/peer-idp/top-locks/obd/health、batch job 状态/描述等 L1 只读摘要模型，用户、用户组、策略、服务账号等 typed 或风险分层入口。
