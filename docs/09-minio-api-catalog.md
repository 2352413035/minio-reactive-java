...
| product typed | S3 77 / 77、Admin 128 / 128、KMS 7 / 7、STS 7 / 7、Metrics 6 / 6、Health 8 / 8 | 这是用户友好强类型成熟度，不代表风险接口已经可以在共享环境中真实执行。 |
| blocked risk | encrypted-blocked 11、destructive-blocked 29 | 这些接口受 madmin 加密响应或破坏性操作边界限制，不能在共享环境中伪装成普通 typed 完成。 |
