...
| product typed | S3 67 / 77、Admin 43 / 128、KMS 7 / 7、STS 4 / 7、Metrics 6 / 6、Health 8 / 8 | 这是用户友好强类型成熟度，不代表剩余路由不能调用。 |
