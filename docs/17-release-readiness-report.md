...
- 新增 bucket quota write + restore、tier verify、remote target list、batch job probe 的可选 lab-only fixture。
...
4. destructive lab 后续继续补 tier/remote target/batch job 的真实可回滚 fixture，并沉淀失败恢复流程。
