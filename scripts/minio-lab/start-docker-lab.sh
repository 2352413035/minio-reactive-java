...
MINIO_LAB_ENABLE_NET_SPEEDTEST_PROBE=${MINIO_LAB_ENABLE_NET_SPEEDTEST_PROBE:-false}
MINIO_LAB_SPEEDTEST_NET_DURATION_SECONDS=${MINIO_LAB_SPEEDTEST_NET_DURATION_SECONDS:-2}
MINIO_LAB_EXPECT_NET_SPEEDTEST_FAILURE=${MINIO_LAB_EXPECT_NET_SPEEDTEST_FAILURE:-false}
MINIO_LAB_NET_SPEEDTEST_EXPECTED_ERROR=${MINIO_LAB_NET_SPEEDTEST_EXPECTED_ERROR:-}
MINIO_LAB_ENABLE_SITE_SPEEDTEST_PROBE=${MINIO_LAB_ENABLE_SITE_SPEEDTEST_PROBE:-false}
...
MINIO_LAB_SITE_SPEEDTEST_EXPECTED_ERROR=${MINIO_LAB_SITE_SPEEDTEST_EXPECTED_ERROR:-}
MINIO_LAB_ENABLE_SERVICE_CONTROL_PROBES=${MINIO_LAB_ENABLE_SERVICE_CONTROL_PROBES:-false}
MINIO_LAB_ENABLE_MAINTENANCE_BOUNDARY_PROBES=${MINIO_LAB_ENABLE_MAINTENANCE_BOUNDARY_PROBES:-false}
...
MINIO_LAB_ENABLE_FORCE_UNLOCK_PROBE=${MINIO_LAB_ENABLE_FORCE_UNLOCK_PROBE:-false}
MINIO_LAB_FORCE_UNLOCK_PATHS=${MINIO_LAB_FORCE_UNLOCK_PATHS:-reactive-lab-bucket/no-such-lock}
